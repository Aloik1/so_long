...
{
	if (player->y == game->textures->collectible_1_x
		&& player->x == game->textures->collectible_1_y
		&& game->textures->collectible_1_state != 0)
		game->textures->collectible_1_state = 0;
	else if (player->y == game->textures->collectible_2_x
		&& player->x == game->textures->collectible_2_y
		&& game->textures->collectible_2_state != 0)
		game->textures->collectible_2_state = 0;
	else if (player->y == game->textures->collectible_3_x
		&& player->x == game->textures->collectible_3_y
		&& game->textures->collectible_3_state != 0)
		game->textures->collectible_3_state = 0;
	else if (player->y == game->textures->collectible_4_x
		&& player->x == game->textures->collectible_4_y
		&& game->textures->collectible_4_state != 0)
		game->textures->collectible_4_state = 0;
	else if (player->y == game->textures->collectible_5_x
		&& player->x == game->textures->collectible_5_y
...
static int	check_and_delete_collectible(t_game *game,
	t_player *player, int i, int j)
{
	if (!game || !player || !game->map
		|| !game->map->collectible || !game->map->collectible->positions)
		return (0);
