...
/*   Updated: 2024/11/25 03:09:44 by aloiki           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	clean_more_floors(t_game *game, t_textures *textures)
{
	...
	{
		mlx_destroy_image(game->window->mlx, textures->floor_bot_right_corner);
		game->textures->floor_bot_right_corner = NULL;
	}
	if (game->textures->floor_top_closed)
	{
		mlx_destroy_image(game->window->mlx, textures->floor_top_closed);
		game->textures->floor_top_closed = NULL;
	}
	if (game->textures->floor_bot_closed)
	{
		mlx_destroy_image(game->window->mlx, textures->floor_bot_closed);
		game->textures->floor_bot_closed = NULL;
	}
	if (game->textures->floor_left_closed)
	{
		mlx_destroy_image(game->window->mlx, textures->floor_left_closed);
		game->textures->floor_left_closed = NULL;
	}
	if (game->textures->floor_right_closed)
	{
		mlx_destroy_image(game->window->mlx, textures->floor_right_closed);
...
void	clean_even_more_floors(t_game *game, t_textures *textures)
{
	...
	{
		mlx_destroy_image(game->window->mlx, textures->floor_left_open);
		game->textures->floor_left_open = NULL;
	}
	if (game->textures->floor_right_open)
	{
		mlx_destroy_image(game->window->mlx, textures->floor_right_open);
		game->textures->floor_right_open = NULL;
	}
	if (game->textures->floor_top_right_corner)
	{
		mlx_destroy_image(game->window->mlx, textures->floor_top_right_corner);
		game->textures->floor_top_right_corner = NULL;
	}
	if (game->textures->floor_top_left_corner)
	{
		mlx_destroy_image(game->window->mlx, textures->floor_top_left_corner);
		game->textures->floor_top_left_corner = NULL;
	}
	if (game->textures->floor_bot_left_corner)
	{
		mlx_destroy_image(game->window->mlx, textures->floor_bot_left_corner);
...
void	clean_floors(t_game *game, t_textures *textures)
{
	...
	{
		mlx_destroy_image(game->window->mlx, textures->floor_all_open);
		game->textures->floor_all_open = NULL;
	}
	if (game->textures->floor_top_bot)
	{
		mlx_destroy_image(game->window->mlx, textures->floor_top_bot);
		game->textures->floor_top_bot = NULL;
	}
	if (game->textures->floor_left_right)
	{
		mlx_destroy_image(game->window->mlx, textures->floor_left_right);
		game->textures->floor_left_right = NULL;
	}
	if (game->textures->floor_top_open)
	{
		mlx_destroy_image(game->window->mlx, textures->floor_top_open);
		game->textures->floor_top_open = NULL;
	}
	if (game->textures->floor_bot_open)
	{
		mlx_destroy_image(game->window->mlx, textures->floor_bot_open);
