...
void					redraw_everything(t_game *game,
							t_textures *textures, int moves);
void					update_camera(t_camera *camera,
							t_player *player, t_map *map);
void					camera_init(t_camera *camera,
							t_player *player, t_map *map);
int						collect_collectible(t_game *game,
							t_player *player);
int						open_exit(t_map *map, t_player *player, t_game *game);
void					draw_exit(t_game *game, t_textures *textures,
							t_camera *camera);
...
void					*choose_player_texture(t_game *game,
							t_movement *movement);
void					more_collectible_textures(
							t_textures *textures, t_map *map);
int						collectible_textures_initialize(
...
void					draw_enemy(t_game *game, int direction,
							int animation, int *coordinates);
int						determine_enemy(t_enemies *enemies, int i, int j);
void					check_collision(t_game *game);
void					draw_info(t_game *game, int moves);
int						positions_for_enemies(t_game *game,
...
void					check_enemy_number(t_game *game, int pos_y,
							int pos_x, int animation);
void					choose_enemy_up_1_2_3_4(t_game *game, int animation,
							int pos_y, int pos_x);
void					choose_enemy_down_1_2_3_4(t_game *game, int animation,
							int pos_y, int pos_x);
void					choose_enemy_left_1_2_3_4(t_game *game, int animation,
							int pos_y, int pos_x);
void					choose_enemy_right_1_2_3_4(t_game *game, int animation,
							int pos_y, int pos_x);
int						check_if_in_camera(t_game *game, int i, int j);
void					update_enemy_1(t_game *game,
							t_enemies *enemies, int i, int j);
void					update_enemy_2(t_game *game,
							t_enemies *enemies, int i, int j);
void					update_enemy_3(t_game *game,
							t_enemies *enemies, int i, int j);
void					update_enemy_4(t_game *game,
							t_enemies *enemies, int i, int j);
void					update_enemy_5(t_game *game,
							t_enemies *enemies, int i, int j);
int						choose_enemy_1(t_game *game, t_enemies *enemies,
							int *params, int updated_1);
int						choose_enemy_2(t_game *game, t_enemies *enemies,
							int *params, int updated_2);
int						choose_enemy_3(t_game *game, t_enemies *enemies,
							int *params, int updated_3);
int						choose_enemy_4(t_game *game, t_enemies *enemies,
							int *params, int updated_4);
int						choose_enemy_5(t_game *game, t_enemies *enemies,
							int *params, int updated_5);
void					update_enemies_position(t_game *game,
							t_enemies *enemies,
							int enemy_number, int *coordinates);
int						three_free_spaces_1(t_game *game, int pos_x, int pos_y);
int						three_free_spaces_2(t_game *game, int pos_x, int pos_y);
int						three_free_spaces_3(t_game *game, int pos_x, int pos_y);
int						three_free_spaces_4(t_game *game, int pos_x, int pos_y);
void					assign_positions(t_game *game, int enemy_number,
							int pos_y, int pos_x);
int						two_free_spaces_0(t_game *game, int pos_y,
							int pos_x, int direction);
int						two_free_spaces_1(t_game *game, int pos_y,
							int pos_x, int direction);
int						two_free_spaces_2(t_game *game, int pos_y,
							int pos_x, int direction);
int						two_free_spaces_3(t_game *game, int pos_y,
							int pos_x, int direction);
int						two_free_spaces_4(t_game *game, int pos_y,
							int pos_x, int direction);
int						even_more_enemies_textures(t_textures *textures,
							void *mlx);
int						even_even_more_floors(t_textures *textures, void *mlx);
int						initial_player_textures(t_game *game, void *mlx);
void					draw_collectible(t_game *game, int i,
							int j, t_window *window);
void					check_collectible_line(t_map *map, char *line);
int						four_free_spaces_3_4(t_game *game, int pos_y,
							int pos_x, int i);
